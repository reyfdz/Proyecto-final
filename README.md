...
Arriba adjuntamos:
Colab del proyecto final(.ipynb), Bases de datos (.csv), Los dos entregables del periodo, y una práctica que utilizamos para hacernos una idea de lo que podiamos hacer
